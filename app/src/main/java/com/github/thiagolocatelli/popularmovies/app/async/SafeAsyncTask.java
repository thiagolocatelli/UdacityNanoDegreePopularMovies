...
public abstract class SafeAsyncTask<ResultT> implements Callable<ResultT> {
    ...
    protected void onThrowable(Throwable t) throws RuntimeException {
        Log.e(getClass().getName(), "onThrowable(): Throwable caught during background processing");
        Log.e(getClass().getName(), "onThrowable(): " + t.getMessage());
    }
        ...
        public Void call() throws Exception {
            try {
                ...
                try {
                    ...
                    // logged but ignored
                    Log.e(getClass().getName(), "call(): " + f.getMessage());
                }
